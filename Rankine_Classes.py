...
class rankineController():
    def __init__(self):
        ...
        and updated the rankineView as well
        """
...
class rankineView():
    ...
    def plot_cycle_TS(self, axObj=None, Model=None):
        ...
        ax.set_xlabel(r's $\left(\frac{kJ}{kg\cdot K}\right)$')  #different than plt
        ax.set_ylabel(r'T $\left( ^{o}C \right)$')  #different than plt
        ...
        ax.text(sMin+0.05*(sMax-sMin), tMax, txt, ha='left', va='top')  #different than plt
