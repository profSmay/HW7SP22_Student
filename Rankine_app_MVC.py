...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.AssignSlots()
        self.MakeCanvas()
        self.RC=rankineController()  # instantiate a rankineController object
    ...
    def Calculate(self):
        ...
        self.RC.setModelValues((self.le_PHigh, self.le_PLow, self.rdo_Quality, self.le_TurbineInletCondition, self.le_TurbineEff))
        #use rankineController to update view based on model
        self.RC.outputToGUI((self.le_H1, self.le_H2, self.le_H3, self.le_H4, self.le_TurbineWork, self.le_PumpWork, self.le_HeatAdded, self.le_Efficiency, self.lbl_SatPropHigh, self.lbl_SatPropLow, self.ax, self.canvas))
